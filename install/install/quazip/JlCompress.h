...
private:
    ...
    //xrender
    static bool xrenderCompressOneFile(QuaZip* zip, QString fileName, QString fileDest,const bool& isCancel);
...
public:
    ...
    //xrender
    static bool xrenderCompress(QString fileCompressed, QString file,const bool& isCancel);
...
public:
    ...
    static QStringList XGTextractDir(QString fileCompressed, QString dir = QString(), QObject *obj = NULL);
    /// Get the file list.
    /**
